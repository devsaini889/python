...
def getvals():
    print("The form is submitting.............")

    print(f"{namevalue.get(), passvalue.get(), clgvalue.get() , id_clgvalue.get() }")

    with open("RECORD.txt","a") as f:
        f.write(f"{namevalue.get(), passvalue.get(), clgvalue.get() , id_clgvalue.get() }")
